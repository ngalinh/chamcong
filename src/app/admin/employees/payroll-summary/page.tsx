  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-white/60 glass overflow-hidden">
        {/* Header row */}
        <div className="px-4 py-2.5 border-b border-neutral-200/60 bg-white/40 grid grid-cols-[1fr_auto_auto_auto] gap-3 items-center">
        ...
        {/* Footer totals */}
        <div className="px-4 py-3 border-t border-neutral-200 bg-emerald-50/60 grid grid-cols-[1fr_auto_auto_auto] gap-3 items-center">
