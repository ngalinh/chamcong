  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-white/60 glass overflow-hidden">
        {/* Header row */}
        <div className="px-4 py-2.5 border-b border-neutral-200/60 bg-white/40 grid grid-cols-[1fr_9rem_8rem_9rem] gap-3 items-center">
          ...
          {rows.map(({ emp, total, ckCongTy }) => {
            ...
            return (
              <div key={emp.id} className="px-4 py-3 hover:bg-white/40 transition-colors">
                ...
                <div className="grid grid-cols-[1fr_9rem_8rem_9rem] gap-3 items-start">
                  <div className="min-w-0">
        ...
        {/* Footer totals */}
        <div className="px-4 py-3 border-t border-neutral-200 bg-emerald-50/60 grid grid-cols-[1fr_9rem_8rem_9rem] gap-3 items-center">
